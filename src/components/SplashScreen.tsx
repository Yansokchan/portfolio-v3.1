  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black">
      ...
      >
        ...
        >
          <Sparkles className="w-10 h-10 text-cosmic-purple hover:text-cosmic-cyan" />
        </motion.div>
        <motion.div
        ...
        >
          <Github className="w-10 h-10 text-cosmic-cyan hover:text-primary transition-colors" />
        </motion.div>
        <motion.div
        ...
        >
          <CodeXml className="w-10 h-10 text-cosmic-cyan hover:text-primary transition-colors" />
        </motion.div>
