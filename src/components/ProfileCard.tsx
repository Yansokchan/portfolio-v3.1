    ...
    >
      <section ref={cardRef} className="pc-card">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-4 left-4 text-cosmic-cyan opacity-80">
            <svg
              viewBox="0 0 32 32"
              width="108"
              height="108"
